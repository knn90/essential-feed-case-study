...
class LoadFeedFromCacheUseCaseTests: XCTestCase {
    ...
    func test_load_hasNoSideEffectOnMoreSevenDaysOldCache() {
        let feed = uniqueImageFeed()
        let fixedCurrentDate = Date()
    ...
    func test_load_doesNotDeliverCompletionAfterSUTHasBeenDealocated() {
    ...
    private func expect(_ sut: LocalFeedLoader, toCompleteWith expectedResult: LoadFeedResult, when action: @escaping () -> Void, file: StaticString = #file, line: UInt = #line) {
