...
class LoadFeedFromCacheUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: LocalFeedLoader, toCompleteWith expectedResult: FeedLoader.Result, when action: @escaping () -> Void, file: StaticString = #file, line: UInt = #line) {
