...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.retrieve() { retrievedResult in
            ...
            case let (.success(.some(retrieveCached)), .success(.some(expectedCached))):
                XCTAssertEqual(retrieveCached.feed, expectedCached.feed, file: file, line: line)
                XCTAssertEqual(retrieveCached.timestamp, expectedCached.timestamp, file: file, line: line)
            default:
